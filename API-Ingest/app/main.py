...
# Date gets ingested as string and then before writing validated
...
def produce_kafka_string(json_as_string):
    # Create producer
    # producer = KafkaProducer(bootstrap_servers='localhost:9093', acks=1) # to test first in local machine
